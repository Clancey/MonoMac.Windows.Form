...
//			bgColorBrush.Dispose();
		...
		{
      // 16 Nov 2010 S. Baer - 
      // Modified SharpDevelop display so only whitespace at the begining
      // of each line is displayed. This was done for python support
      bool hitNonSpace = false;
        ...
        else
        {
          ...
          hitNonSpace = true;
				...
				if (currentWord.Type == TextWordType.Space) {
                    ...
                    // Modified SharpDevelop display so only whitespace at the begining
                    // of each line is displayed. This was done for python support
					if (!hitNonSpace && TextEditorProperties.ShowSpaces) {
